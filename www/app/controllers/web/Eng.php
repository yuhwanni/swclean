 ...
 * @property
 */
class Eng extends FW_Controller
{
    ...
    function index_old() {
        ...
        $this->render( 'web/eng/index_bak', $this->data, LAYOUT_HLCRF );
    }
    ...
    function index() {
        ...
        $this->render( 'web/eng/index', $this->data, LAYOUT_HLCRF );
    }
    ...
    /*function index2() {
        ...
        $this->render( 'web/eng/__index', $this->data, LAYOUT_HLCRF );
    }*/
    ...
    /*function productPro() {
        ...
        $this->render( 'web/eng/product/productPro', $this->data, LAYOUT_HLCRF );
    }
    ...
    function productLite() {
        ...
        $this->render( 'web/eng/product/productLite', $this->data, LAYOUT_HLCRF );
    }*/
    ...
    function product() {
        ...
        $this->render( 'web/eng/product/index', $this->data, LAYOUT_HLCRF );
    }
    ...
    function pixelscope() {
        ...
        $this->render( 'web/eng/pixelscope/index', $this->data, LAYOUT_HLCRF );
    }
    ...
    /*function billiards() {
        ...
        $this->render( 'web/eng/sports/billiards', $this->data, LAYOUT_HLCRF );
    }
    ...
    function baseball() {
        ...
        $this->render( 'web/eng/sports/baseball', $this->data, LAYOUT_HLCRF );
    }*/
    ...
    /*function valleyball() {
        ...
        $this->render( 'web/eng/sports/valleyball', $this->data, LAYOUT_HLCRF );
    }
    ...
    function tennis() {
        ...
        $this->render( 'web/eng/sports/tennis', $this->data, LAYOUT_HLCRF );
    }*/
    ...
    function sports() {
        ...
        $this->render( 'web/eng/sports/sports', $this->data, LAYOUT_HLCRF );
    }
    ...
    /*function company() {
        ...
        $this->render( 'web/eng/company/company', $this->data, LAYOUT_HLCRF );
    }*/
    ...
    function news() {
        ...
        $this->render( 'web/eng/news/news', $this->data, LAYOUT_HLCRF );
    }
    ...
    function news_view() {
        ...
        $this->render( 'web/eng/news/news_view', $this->data, LAYOUT_HLCRF );
    }
    ...
    function contact() {
        ...
        $this->render( 'web/eng/contact/contact', $this->data, LAYOUT_HLCRF );
    }
        ...
        switch($mode) {
            ...
            case "QNA_ENG":
                ...
                if ($result) {
                    ...
                    $rst_json = array('rst' => 'S', 'msgTxt' => "It's registered.");
                } else {
