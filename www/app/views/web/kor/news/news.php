                ...
                <div class="col-lg-12">
                    <div class="blog-posts">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-5">
                                        <div class="post-image">
                                            <a href="/web/kor/news_view?bd_idx=<?=$bd_idx?>">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="post-content">
                                            <h2 class="font-weight-semibold pt-4 pt-lg-0 text-5 line-height-4 mb-2">
                                                <a href="/web/kor/news_view?bd_idx=<?=$bd_idx?>"><?=$bd_subject?></a>
                                            </h2>
                                            <p class="mb-0">
                                                <?=$bd_content?>
                                            </p>
                                    ...
                                    <div class="col">
                                        <div class="post-meta">
                                            ...
                                            <span class="d-block d-sm-inline-block float-sm-end mt-3 mt-sm-0">
                                                <a href="/web/kor/news_view?bd_idx=<?=$bd_idx?>" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?
                            ...
                            echo "<div class='align-middle text-center' style='min-height:250px; line-height: 200px'>등록된 내역이 없습니다.</div>";
                        }
                        ?>
