...
<div role="main" class="main">
    ...
    <!-- 메인 최상단 -->
    <section class="section section-with-shape-divider section-parallax bg-tertiary border-0 m-0"
             data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '110%', 'fadeIn': true}"
             data-image-src="/web/assets/img/main/main01.jpg"
    >
            ...
            <div class="row justify-content-center justify-content-lg-start pb-5 mb-5">
                <div class="col-md-10 col-lg-6 text-center text-lg-end pe-lg-4 pb-5 mb-5">
                    <h1 class="text-color-light font-weight-medium line-height-4 text-10 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
                        인간과 환경을 생각하는
                        <span class="font-weight-extra-bold custom-highlight-1 ws-nowrap p-1 customHighlightAnim customHighlightAnimDelay">사회적 기업</span>
                    </h1>
                    <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                        <p class="font-weight-light custom-font-size-1 text-color-light opacity-6 mb-4">
                            성우환경은 기업이윤의 사회환원과 취약계층 및 장애인 고용으로
                            사회와 함께 성장하는 사회적기업, 여성기업입니다.
                        </p>
                    </div>
        ...
        <div class="container mt-2 mb-5 pb-5">
            <div class="row align-items-center mb-4">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <h3 class="font-weight-bold text-transform-none line-height-2 text-8 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
...
<!--                            <img src="/web/assets/img/main/main02.png" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800" alt="" />-->
<!--                        </div>-->
...
<!--                                <img src="/web/assets/img/main/main03.png" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1400" alt="" />-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
                                ...
                                <div class="card custom-card-style-1">
                                    <div class="card-body text-center py-5">
                                        <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                            <img src="/web/assets/img/main/services-small-1.jpg" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                        <h4 class="custom-card-style-1-title text-color-secondary font-weight-bold mb-2">
                                            건물 위생관리
                                        </h4>
                                        <p class="custom-card-style-1-description">
                                            건물 위생관리에 대해 간략하게 설명이 들어가야 합니다. 확인해주세요. 확인해주세요. 확인해주세요.
                                        </p>
                                        <span class="custom-card-style-1-link font-weight-bold">더보기</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="demo-cleaning-services-services-detail.html" class="text-decoration-none">
                                <div class="card custom-card-style-1">
                                    <div class="card-body text-center py-5">
                                        <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                            <img src="/web/assets/img/main/service02.jpg" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                        <h4 class="custom-card-style-1-title text-color-secondary font-weight-bold mb-2">
                                            에어컨 청소
                                        </h4>
                                        <p class="custom-card-style-1-description">130*130 서비스에 맞는 이미지가 필요합니다. 130*130 서비스에 맞는 이미지가 필요합니다. </p>
                                        <span class="custom-card-style-1-link font-weight-bold">더보기</span>
                                    </div>
                                </div>
                            </a>
    ...
    <? /* ?>
    <section class="section section-with-shape-divider section-height-3 overlay overlay-show overlay-color-tertiary border-0 m-0"
             style="background-image: url('/web/assets/img/main/main5.jpg'); background-size: cover; background-position: center;">
            ...
            <div class="row align-items-center justify-content-center pt-3">
                <div class="col-md-9 col-lg-7 col-xl-9 text-center text-xl-start mb-4 mb-xl-0">
                    <h2 class="text-color-light font-weight-medium line-height-4 text-9 negative-ls-1 mb-2">
                        고객센터 전화번호
                        <span class="font-weight-extra-bold custom-highlight-1 p-1 appear-animation" data-appear-animation="customHighlightAnim" data-appear-animation-delay="300">
                            031-559-5116 ~ 5118
                        </span> </h2>
                ...
                <div class="col-xl-3 text-center text-xl-end">
                    <div class="position-relative">
                        <a href="demo-cleaning-services-contact.html" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3 appear-animation" data-appear-animation="fadeInRightShorter" 
                           data-appear-animation-delay="550">온라인 문의 바로가기</a>
                    </div>
                </div>
            </div>
        </div>
