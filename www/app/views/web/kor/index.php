    ...
    <div class="revolution-slider" data-version="5.4.5">
        <ul>
            ...
            <li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
                ...
                >
                    <h4>A company that thinks about people and the environment.</h4>
                </div>
                <!-- LAYER 02 -->
                <div class="tp-caption"
                ...
                >
                    <h2><a href="service_calculator.html" title="Estimate Total Costs" style="font-size:2.2rem">인간과 환경을 생각하는</a></h2>
                </div>
                <!-- LAYER 03 -->
                <div class="tp-caption"
                ...
                >
                    <h2 class="slider-subtitle"><strong style="font-size:2.2rem">사회적기업 주식회사 성우</strong></h2>
                </div>
                <!-- LAYER 04 -->
                <div class="tp-caption"
...
<div class="theme-page">
    <div class="clearfix">
        <div class="row margin-top-89">
            <div class="row">
                <h2 class="box-header">ABOUT COMPANY</h2>
                <p class="description align-center">
                    주식회사 성우는 사회적가치를 추구하면서 수익창출 및 재투자를 통해 취업취약계층에게 지속적이고 안정적인 일자리를 제공하는 회사입니다.
                </p>
                <div class="row page-margin-top">
                    ...
                    <div class="column column-1-2 align-center">
                        <div class="image-wrapper">
                            <img src="/web/assets/images/main/main_480.jpg" alt="" class="radius border">
                        </div>
                    </div>
                    <div class="column column-1-4">
