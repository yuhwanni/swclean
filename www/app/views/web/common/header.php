                    ...
                    <div class="header-column justify-content-start">
                        <div class="header-row">
                            <ul class="nav nav-pills position-relative bottom-1 ms-md-3">
                                <li class="nav-item">
                                    <span class="d-flex align-items-center ws-nowrap text-color-secondary font-weight-medium text-3">
                                        <img alt="성우" src="/web/assets/img/logos/logo_top02.png">
<!--                                        사회적기업 | 여성기업 | 일자리 우수기업-->
                                    </span>
                                </li>
                            </ul>
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-row" style="height:50px;"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="header-column w-100">
                    <div class="header-row justify-content-between">
                        <div class="header-logo z-index-2 col-lg-2 px-0">
                            <a href="/">
                                <img alt="성우" src="/web/assets/img/logos/logo_top.png">
                            </a>
                        </div>
