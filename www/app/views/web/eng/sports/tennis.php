<div role="main" class="main">
    ...
    <section class="section section-concept section-no-border section-dark section-angled section-angled-reverse p-relative z-index-2 pt-5 m-0"
             style="background-image: url(/web/img/landing/header_bg.jpg); background-size: cover; background-position:
            ...
            <div class="row pt-3 pb-lg-0 pb-xl-0">
                <div class="col-lg-6 pt-4 mb-5 mb-lg-0">
                    <ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
                        ...
                        <li class="text-color-primary"><a href="elements.html">TENNIS</a></li>
                    </ul>
                    <h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">TENNIS</h1>
                    <p class="font-weight-light opacity-7 pb-2 mb-4">Everything you need to create your website with endless possibilities.</p>
                </div>
            </div>
        </div>
    </section>
