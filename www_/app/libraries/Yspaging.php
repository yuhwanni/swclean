...
class YsPaging {
	...
	*/
	public function getFirstPage() {
		...
		return '<li><a href="?'.$this->mPageVar.'=1'.$this->mExtraVar.'">'.$this->mFirstPage.'</a></li>';
	}
	...
	*/
	public function getLastPage() {
		...
		return '<li><a href="?'.$this->mPageVar.'='.$this->mPageCount.$this->mExtraVar.'">'.$this->mLastPage.'</a></li>';
	}
	...
	*/
	public function getPrevPerPage() {
		...
		return '<li><a href="?'.$this->mPageVar.'='.$this->mFirstPerPage.$this->mExtraVar.'">'.$this->mPrevPerPage.'</a></li>';
	}
	...
	*/
	public function getNextPerPage() {
		...
		return '<li><a href="?'.$this->mPageVar.'='.($this->mLastPerPage+1).$this->mExtraVar.'">'.$this->mNextPerPage.'</a></li>';
	}
	...
	*/
	public function getPrevPage() {
		if($this->mCurPageNum > 1)
			return '<li><a href="?'.$this->mPageVar.'='.($this->mCurPageNum-1).$this->mExtraVar.'">'.$this->mPrevPage.'</a></li>';
		else
			return '<li><a href="javascript:;">'.$this->mPrevPage.'</a></li>';
	}
	...
	*/
	public function getNextPage() {
		if($this->mCurPageNum != $this->mPageCount && $this->mPageCount)
			return '<li><a href="?'.$this->mPageVar.'='.($this->mCurPageNum+1).$this->mExtraVar.'">'.$this->mNextPage.'</a></li>';
		else
			return '<li><a href="javascript:;">'.$this->mNextPage.'</a></li>';
	}
	...
	public function getPageList() {
		...
		for($i=$this->mFirstPerPage+1;$i<=$this->mLastPerPage;$i++) {
			if($this->mCurPageNum == $i)
				$rtn .= '<li class="'.$this->mCurPageCss.'"><a href="javascript:;">'.$i.'</a></li>';
			else {
				$rtn .= '<li><a href="?'.$this->mPageVar.'='.$i.$this->mExtraVar.'">'. $i .'</a></li>';
			}
		}
		return $rtn;
	}
