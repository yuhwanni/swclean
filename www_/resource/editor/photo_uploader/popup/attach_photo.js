    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/web/board/editor_upload_html5.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		...
 		var cd = opener.parent.document.getElementById('cd').value;
		var action_url = opener.parent.document.getElementById('edit_action').value;

 		console.log(cd);
		console.log(action_url);

 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : action_url,	//샘플 URL입니다.
